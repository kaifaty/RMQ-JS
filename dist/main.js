...
function () {
  ...
  _createClass(SparsTables, [{
    ...
    key: "query",
    value: function query(i, j) {
      if (!this.ST) {
        return false;
      }

      var k = Math.ceil(Math.log(j - i + 1));
      return Math[this.type](this.ST[k][i], this.ST[k][j - Math.pow(2, k) + 1]);
    }
  }]);
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "18857" + '/');
...
},{}]},{},["../../../Users/Kaifat/AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","main.ts"], null)
